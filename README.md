...
|----------|--------------|-------|
| [Customer Churn Analysis and Prediction](https://github.com/anuragchauhan21/customer-churn-analysis) | Analyzed & predicted telecom customer churn using EDA and Logistic Regression to identify high-risk customers, key churn drivers and expected loss. | Python, Machine Learning |
